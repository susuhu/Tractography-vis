...
\begin{figure}[ht]
    \centering
    \includegraphics[width = 0.40 \columnwidth]{isorainbow-fa-task2}
    \includegraphics[width = 0.44 \columnwidth]{isorainbow-md-task2}
    \caption{Illustration of the questions for left side of the brain, based on Task2 for Isoluminant-rainbow colormap. a)Fa and b)MD }
    \label{fig:task2}
\end{figure}	
